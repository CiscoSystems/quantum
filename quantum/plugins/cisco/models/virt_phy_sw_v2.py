...
class VirtualPhysicalSwitchModelV2(quantum_plugin_base_v2.QuantumPluginBaseV2):
    ...
    def __getattribute__(self, name):
        ...
        sub-plugin. Normally, bulking calls are handled by PluginV2 and are
        broken into non-bulking calls, but if bulking calls are made here,
        they'll get delegated to the OVS plugin.
        """
