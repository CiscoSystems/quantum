...
class TestL3RouterAppliancePlugin(
    ...
    l3_router_applicance_db.L3_router_appliance_db_mixin):
    pass
...
class L3RouterApplianceTestCase(test_extension_extraroute.ExtraRouteDBTestCase):
    ...
    def setUp(self):
        ...
        self.ip_cls_p = mock.patch('quantum.plugins.cisco.l3.db.l3_router_applicance_db.L3_router_appliance_db_mixin')
