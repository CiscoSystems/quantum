...
#       - DFA support: Added new parameters to networks database.
#
...
RESOURCE_ATTRIBUTE_MAP = {
    'networks': {
        ...
        'tenant_id': {'allow_post': True, 'allow_put': False,
                      ...
                      'is_visible': True},
        'config_profile': {'allow_post': True,
                           'allow_put': True,
                           'type:string': None,
                           'default': '',
                           'required': True,
                           'is_visible': True},
        'forwarding_mode': {'allow_post': True,
                            'allow_put': True,
                            'type:string': None,
                            'default': '',
                            'required': True,
                            'is_visible': True},
        'gateway_mac': {'allow_post': True,
                        'allow_put': True,
                        'type:string': None,
                        'default': '',
                        'required': True,
                        'is_visible': True},
        'partition_name': {'allow_post': True,
                           'allow_put': True,
                           'type:string': None,
                           'validate': {'type:string': None},
                           'default': '',
    ...
    'ports': {
        ...
        'fixed_ips': {'allow_post': True, 'allow_put': True,
                      ...
                      'enforce_policy': True,
                      'is_visible': True},
        'dfa_vm_ip': {'allow_post': True, 'allow_put': True,
                      'default': '0.0.0.0',
                      'validate': {'type:string': None},
                      'is_visible': True},
