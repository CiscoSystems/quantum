...
from quantum.plugins.ml2.drivers import type_vxlan
...
class VXLANTypeTest(base.BaseTestCase):
    ...
    def test_vxlan_tunnel_type(self):
        self.assertEqual(self.driver.get_type(), type_tunnel.TYPE_VXLAN)
    ...
    def test_sync_tunnel_allocations(self):
        self.assertIsNone(self.driver.
                          get_vxlan_allocation(self.session, (TUN_MIN - 1)))
        self.assertFalse(self.driver.
                         get_vxlan_allocation(self.session, (TUN_MIN)).
                         allocated)
        self.assertFalse(self.driver.
                         get_vxlan_allocation(self.session, (TUN_MIN + 1)).
                         allocated)
        self.assertFalse(self.driver.
                         get_vxlan_allocation(self.session, (TUN_MAX - 1)).
                         allocated)
        self.assertFalse(self.driver.
                         get_vxlan_allocation(self.session, (TUN_MAX)).
                         allocated)
        self.assertIsNone(self.driver.
                          get_vxlan_allocation(self.session, (TUN_MAX + 1)))
